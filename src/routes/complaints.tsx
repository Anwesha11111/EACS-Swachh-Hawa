...
const COMPLAINTS = [
  { id: "CMP-4821", citizen: "Rahul M., Delhi", type: "Industrial Smoke", loc: "Wazirpur Industrial Area", ts: "2026-05-30T04:11", verified: true, correlation: "Sensor SH-DEL-0042 corroborates — PM2.5 spike 356 µg/m³", status: "Escalated to Enforcement", dossier: "ENF-2026-0341" },
  { id: "CMP-4820", citizen: "Priya S., Ghaziabad", type: "Construction Dust", loc: "NH-9 Bypass Site", ts: "2026-05-30T03:48", verified: true, correlation: "SH-GZB-0018 PM10 elevated 3× baseline", status: "Under Investigation", dossier: "ENF-2026-0340" },
  { id: "CMP-4819", citizen: "Anonymous", type: "Garbage Burning", loc: "Yamuna Khadar", ts: "2026-05-30T02:22", verified: false, correlation: "No sensor within 500m — drone survey dispatched", status: "Drone Dispatched", dossier: null },
  { id: "CMP-4818", citizen: "Amit K., Patna", type: "Brick Kiln Smoke", loc: "Phulwari Sharif", ts: "2026-05-29T22:01", verified: true, correlation: "SH-PNA-0031 PM2.5 287 µg/m³ sustained 45 min", status: "Dossier Compiled", dossier: "ENF-2026-0338" },
  { id: "CMP-4817", citizen: "Sunita D., Bengaluru", type: "Vehicle Emission", loc: "Outer Ring Road", ts: "2026-05-29T19:44", verified: false, correlation: "No fixed sensor — flagged for mobile vehicle check", status: "Pending Verification", dossier: null },
];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        {[
          { l: "Received 24h", v: "94", c: "primary", icon: <MessageSquare className="h-4 w-4" /> },
          { l: "Sensor-Verified", v: "61", c: "emerald", icon: <CheckCircle2 className="h-4 w-4" /> },
          { l: "Escalated to Enforcement", v: "28", c: "rose", icon: <AlertTriangle className="h-4 w-4" /> },
            ...
            <tbody>
              {COMPLAINTS.map(c => (
                <tr key={c.id} className="border-b border-border/40 hover:bg-accent/40">
                  ...
                  <td className="px-3 py-2.5 text-muted-foreground">{c.citizen}</td>
                  <td className="px-3 py-2.5">{c.type}</td>
                  <td className="px-3 py-2.5 max-w-[140px] truncate text-muted-foreground">{c.loc}</td>
                  <td className="px-3 py-2.5 mono text-[10px] text-muted-foreground whitespace-nowrap">{c.ts.replace("T"," ")}</td>
                  <td className="px-3 py-2.5">
                    {c.verified ? <span className="text-[var(--emerald)] font-bold">✓</span> : <span className="text-[var(--amber)]">Pending</span>}
                  </td>
                  <td className="px-3 py-2.5 max-w-[200px] text-[10px] text-muted-foreground">{c.correlation}</td>
                  <td className="px-3 py-2.5">
