...
- [x] Add state management for forecast city dropdown (Delhi/Mumbai/Bangalore/Chennai)
- [x] Add state management for heatmap metric dropdown (PM2.5/AQI/PM10/NO₂)
- [x] Add state management for trend period dropdown (24H/7 Days/30 Days)
- [x] Close dropdowns on selection to prevent state conflicts
- [x] Test all dropdowns toggle correctly on click
- [x] Verify dropdown z-index positioning doesn't conflict with other elements
